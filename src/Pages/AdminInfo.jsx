    ...
    <div className="max-w-sm mx-auto mt-10 p-6 rounded-xl border-border border shadow-sm bg-card">
      {user ? (
        ...
        <div>
          ...
          <div>
            <button
              className="p-3 bg-primary/60 -mb-2 hover:bg-primary hover:scale-105 cursor-pointer font-bold mt-4 rounded-xl transition-all duration-300"
