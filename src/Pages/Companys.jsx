  ...
  return (
    <div>
      ...
      <div className="flex justify-around items-center p-2">
        ...
        />
        <button className="px-3 crouser-pointer font-medium py-2  h-fit whitespace-nowrap w-fit bg-primary/50 hover:bg-primary/80 text-foreground rounded-xl transition-all duration-300 cursor-pointer ">
      ...
      <div className="relative h-full border-t-4 border-blue-200 rounded-2xl w-full overflow-hidden p-10">
        ...
        <div className="z-100 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full h-full">
          {loder &&  Array.from({ length: 6 }).map((_, i) => (
      <div
        key={i}
      ...
      >
        ...
        <div className="h-4 w-1/3 bg-gray-400/20 rounded"></div>
          ...
          {companys.length > 0
            ...
            : "Data Not Found, Please Refresh Again"}
        </div>
      </div>
    </div>
  );
